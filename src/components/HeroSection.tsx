      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <div className="max-w-4xl mx-auto animate-on-scroll animate-pulse-subtle">
          ...
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold text-warm-text mb-8 animate-fade-in leading-tight font-sans"
            ...
            Откройте себя настоящего. За пределами страха и тревоги.
          </h1>

          <h2 className="text-lg md:text-xl lg:text-2xl text-warm-text/90 font-medium mb-8 animate-slide-up leading-relaxed max-w-3xl mx-auto">
            Мой авторский метод — это уникальное сочетание <br />
            глубины гипнотерапии и мудрости адвайты.<br />
            Он поможет вам увидеть, что страх и тревога — это лишь процессы, за которыми можно наблюдать.<br />
            Вы поймёте, чего хотите на самом деле, и обретёте внутреннюю свободу.
          </h2>
