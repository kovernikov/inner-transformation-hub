...
const CertificatesSection = () => {
  const certificates = [
    ...
    },
    {
      ...
      alt: "Дополнительный сертификат Алексея Коверникова",
      title: "Дополнительная квалификация"
    },
    {
      id: 10,
      src: "/lovable-uploads/a6bd6433-86a2-46de-ad99-713c53b72099.png",
      alt: "Сертификат теории и практики консультирования Алексея Коверникова",
      title: "Теория и практика консультирования"
    }
  ];
